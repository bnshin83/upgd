...
#SBATCH --array=0-3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_ant_upgd_full.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_ant_upgd_full.err
...
export WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_ant_upgd_full_seed_${SEED1}"
...
export WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_ant_upgd_full_seed_${SEED2}"
python3 core/run/rl/run_ppo_upgd.py \
    --env_id Ant-v4 \
    --seed $SEED2 \
    --total_timesteps 20000000 \
