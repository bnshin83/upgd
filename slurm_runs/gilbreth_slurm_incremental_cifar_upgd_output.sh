...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_incr_cifar_upgd_output.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_incr_cifar_upgd_output.err
