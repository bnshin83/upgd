...
#SBATCH --array=0-19%8
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%A_%a_si_baselines.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%A_%a_si_baselines.err
...
# lr=0.001, beta_weight=0.999, beta_importance=0.9, lamda=1.0
LR=0.001
BETA_WEIGHT=0.999
BETA_IMPORTANCE=0.9
LAMDA=1.0
