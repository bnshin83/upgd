#!/bin/bash
#SBATCH --job-name=rl_cheetah_all
...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_halfcheetah.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_halfcheetah.err

# HalfCheetah-v4 PPO: 4 methods × 20 seeds = 80 tasks
#   0-19:  adam
#  20-39:  upgd_full
...
echo "========================================="
echo "HalfCheetah-v4 PPO — ${METHOD} — seed ${SEED}"
