...
#SBATCH --array=0-4%3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_upgd.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_upgd.err
