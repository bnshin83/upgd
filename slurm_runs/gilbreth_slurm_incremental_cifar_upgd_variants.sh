...
#SBATCH --array=0-8
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_incr_cifar_upgd_sweep.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_incr_cifar_upgd_sweep.err
