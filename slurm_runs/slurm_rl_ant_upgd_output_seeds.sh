...
#SBATCH --array=0-30%8
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%A_%a_rl_ant_upgd_output.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%A_%a_rl_ant_upgd_output.err
...
WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_ant_upgd_output_only_seed_${SEED}" \
