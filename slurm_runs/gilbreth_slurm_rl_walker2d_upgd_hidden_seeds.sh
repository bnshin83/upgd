#!/bin/bash
#SBATCH --job-name=rl_walker2d_upgd_hidden_seeds
...
#SBATCH --array=0-4%3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_walker2d_upgd_hidden.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_walker2d_upgd_hidden.err
...
echo "========================================="
echo "Running RL: Walker2d-v4 - UPGD Hidden Only"
...
for i in 0 1; do
    ...
    if [ $SEED_IDX -lt $NUM_SEEDS ]; then
        ...
        WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_walker2d_upgd_hidden_seed_${SEED}" \
