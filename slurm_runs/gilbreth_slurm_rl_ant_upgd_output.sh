...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_rl_ant_upgd_output.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_rl_ant_upgd_output.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_ant_upgd_output_only_seed_0"
