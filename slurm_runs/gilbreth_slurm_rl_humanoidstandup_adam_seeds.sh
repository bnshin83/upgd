#!/bin/bash
#SBATCH --job-name=rl_humanoidstandup_adam_seeds
...
#SBATCH --array=0-4%3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_adam.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_adam.err
...
echo "========================================="
echo "Running RL: HumanoidStandup-v4 - Adam"
...
for i in 0 1; do
    ...
    if [ $SEED_IDX -lt $NUM_SEEDS ]; then
        ...
        WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_humanoidstandup_adam_seed_${SEED}" \
...
echo "========================================="
echo "Adam experiments completed"
echo "End time: $(date)"
echo "========================================="
