...
#SBATCH --array=0-19%8
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%A_%a_snp_baselines.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%A_%a_snp_baselines.err
...
# Hyperparameters: S&P optimizer takes (lr, weight_decay, sigma)
# weight_decay = shrinkage factor, sigma = noise scale
# Per-dataset best hyperparams
case $DATASET_IDX in
    0)  # EMNIST
