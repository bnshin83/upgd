...
#SBATCH --array=0-4%3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_upgd_hidden.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoidstandup_upgd_hidden.err
