...
#SBATCH --array=0-19%8
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%A_%a_ewc_baselines.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%A_%a_ewc_baselines.err
...
# lr=0.01, beta_weight=0.9999, beta_fisher=0.9999, lamda=1.0
LR=0.01
BETA_WEIGHT=0.9999
BETA_FISHER=0.9999
LAMDA=1.0
