#!/bin/bash
#SBATCH --job-name=rl_humanoid_upgd_seeds
...
#SBATCH --array=0-4%3
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoid_upgd.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_rl_humanoid_upgd.err
...
echo "========================================="
echo "Running RL: Humanoid-v4 - UPGD Full Gating"
...
for i in 0 1; do
    ...
    if [ $SEED_IDX -lt $NUM_SEEDS ]; then
        ...
        WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_humanoid_upgd_full_seed_${SEED}" \
