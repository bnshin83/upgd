...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%A_%a_qt_humanoid_fixed.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%A_%a_qt_humanoid_fixed.err

# Quick test: Humanoid-v4 with fixed optimizer (RLLayerSelectiveUPGD for all modes)
...
export WANDB_RUN_NAME="${SLURM_ARRAY_JOB_ID}_qt_humanoid_${METHOD}_seed42_fixed"

echo "=========================================="
echo "Quick test: Humanoid-v4 - ${METHOD} (FIXED optimizer)"
