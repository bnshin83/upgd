#!/bin/bash
#SBATCH --job-name=rl_hstandup_all
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%A_%a_rl_humanoidstandup.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%A_%a_rl_humanoidstandup.err

# HumanoidStandup-v4 PPO: 4 methods × 20 seeds = 80 tasks
#   0-19:  adam
#  20-39:  upgd_full
...
echo "========================================="
echo "HumanoidStandup-v4 PPO — ${METHOD} — seed ${SEED}"
