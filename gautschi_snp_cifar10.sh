...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_snp_cifar10_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_snp_cifar10_seed_2.err
...
echo "WandB Run: ${WANDB_RUN_NAME}"
echo "SLURM logs: /scratch/gautschi/shin283/upgd/logs/${SLURM_JOB_ID}_snp_cifar10_seed_2.out"
echo "========================================"
