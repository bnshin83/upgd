...
from core.utils import feature_utility_factory
...
class FeatureRunUtility(Run):
    ...
    def start(self):
        ...
        oracle_factory = feature_utility_factory['oracle'](self.learner.network, criterion)
        util_measure_corr_global = {}
        util_measure_corr_layerwise = {}
        for utility_measure in feature_utility_factory.keys():
            if utility_measure == 'oracle':
                continue
            util_measure_corr_global[feature_utility_factory[utility_measure](self.learner.network, criterion)] = []
            util_measure_corr_layerwise[feature_utility_factory[utility_measure](self.learner.network, criterion)] = []
