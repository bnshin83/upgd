...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}__{args.exp_name}__{args.seed}__wd{args.weight_decay}__sigma{args.sigma}__beta{args.beta_utility}__{int(time.time())}"
    if args.track:
        import wandb
    ...
    optimizer = AdaptiveUPGD(agent.parameters(), lr=args.learning_rate, eps=1e-5, weight_decay=args.weight_decay, beta_utility=args.beta_utility, sigma=args.sigma)
