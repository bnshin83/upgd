    ...
    def __init__(self, n_samples=10000, task=None, learner=None, save_path="logs", seed=0, network=None, 
        ...
        if WANDB_AVAILABLE and os.environ.get('WANDB_PROJECT'):
            try:
                ...
                # Seed an initial log so the Charts tab appears immediately
                try:
                    wandb.log({
                        'training/step': 0,
                        'training/global_progress': 0.0,
                        'training/task_progress': 0.0,
                        'curvature/current': 0.0,
                        'curvature/avg': 0.0,
                        'curvature/max': 0.0,
                        'gradients/l2_norm': 0.0,
                        'weights/l2_norm': 0.0,
                        'network/dead_units_ratio': 0.0,
                    }, step=0)
                except Exception:
                    pass
