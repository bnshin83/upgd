...
# Try to import wandb, fall back gracefully if not available
try:
    import wandb
    WANDB_AVAILABLE = True
except ImportError:
    WANDB_AVAILABLE = False
    print("Warning: wandb not available. Install with 'pip install wandb' for enhanced tracking.")
...
class RunStatsWithCurvature:
    ...
    def __init__(self, n_samples=10000, task=None, learner=None, save_path="logs", seed=0, network=None, 
                 compute_curvature_every=1, **kwargs):
        ...
        # Check if this is an input-aware learner
        self.is_input_aware = 'input_aware' in learner
...
n
            ...
            if self.wandb_enabled and i % 10 == 0:
                ...
                # Add curvature metrics for input-aware learners
                if self.is_input_aware and input_curvature_per_step:
        ...
        # Add curvature data for input-aware learners
        if self.is_input_aware:
            log_data.update({
        ...
        if self.wandb_enabled:
            ...
            # Add curvature summary for input-aware learners
            if self.is_input_aware and input_curvature_per_step:
