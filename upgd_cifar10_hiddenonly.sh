#!/bin/bash
#SBATCH --job-name=upgd_hiddenonly_cifar10_seed_2
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_hiddenonly_cifar10_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_hiddenonly_cifar10_seed_2.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_hiddenonly_cifar10_seed_2"
export WANDB_MODE="online"

echo "========================================="
echo "Running UPGD Hidden-Only Gating (CIFAR-10)"
