#!/usr/bin/env python3
"""
Plotting script for continual learning experiments.

Usage:
    python plot_training_metrics.py [dataset]
...
# ============================================================================
# Each dataset has different log paths and experiment configurations

DATASET_CONFIGS = {
    # =========================================================================
    # Mini-ImageNet: S&P (lr=0.01, σ=0.01, λ=0.001), UPGD (lr=0.01, σ=0.001, β=0.9, λ=0.0)
    # =========================================================================
    'mini_imagenet': {
    ...
    # =========================================================================
    # EMNIST: S&P (lr=0.01, σ=0.01, λ=0.001), UPGD (lr=0.01, σ=0.001, β=0.9, λ=0.0)
    # =========================================================================
    'emnist': {
    ...
    # =========================================================================
    # CIFAR-10: S&P (lr=0.01, σ=0.01, λ=0.001), UPGD (lr=0.01, σ=0.001, β=0.999, λ=0.0)
    # =========================================================================
    'cifar10': {
...
def set_dataset(dataset):
    ...
    LOGS_DIR = BASE_DIR / 'logs' / config['logs_subdir']
...
def main():
    ...
    if not EXPERIMENTS:
        ...
        print("Please add experiment paths to DATASET_CONFIGS in this script")
        return
