...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_output_only.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_output_only.err
...
echo "Experiment: UPGD Output-Only Gating (fc layer only)"
echo "Seed: 0"
echo "Start time: $(date)"
echo "========================================="

export CUDA_VISIBLE_DEVICES=0
export WANDB_RUN_NAME="${SLURM_JOB_ID}_incr_cifar_upgd_output_only_seed_0"

python3.8 incremental_cifar_experiment.py \
    --config ./cfg/upgd_output_only.json \
    --verbose \
    --experiment-index 0

echo "========================================="
echo "UPGD Output-Only Gating experiment completed"
echo "End time: $(date)"
echo "========================================="
