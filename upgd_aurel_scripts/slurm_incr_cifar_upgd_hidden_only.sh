#!/bin/bash
#SBATCH --job-name=incr_cifar_upgd_hidden
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_hidden_only.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_hidden_only.err
...
echo "Experiment: UPGD Hidden-Only Gating (all except fc layer)"
echo "Seed: 0"
echo "Start time: $(date)"
echo "========================================="

export CUDA_VISIBLE_DEVICES=0
export WANDB_RUN_NAME="${SLURM_JOB_ID}_incr_cifar_upgd_hidden_only_seed_0"

python3.8 incremental_cifar_experiment.py \
    --config ./cfg/upgd_hidden_only.json \
    --verbose \
    --experiment-index 0

echo "========================================="
echo "UPGD Hidden-Only Gating experiment completed"
echo "End time: $(date)"
echo "========================================="
