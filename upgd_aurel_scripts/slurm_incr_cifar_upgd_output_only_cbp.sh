#!/bin/bash
#SBATCH --job-name=incr_cifar_upgd_output_cbp
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_output_only_cbp.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_upgd_output_only_cbp.err
...
echo "Experiment: UPGD Output-Only Gating + Continual Backprop"
echo "Seed: 0"
echo "Start time: $(date)"
echo "========================================="

export CUDA_VISIBLE_DEVICES=0
export WANDB_RUN_NAME="${SLURM_JOB_ID}_incr_cifar_upgd_output_only_cbp_seed_0"

python3.8 incremental_cifar_experiment.py \
    --config ./cfg/upgd_output_only_cbp.json \
    --verbose \
    --experiment-index 0

echo "========================================="
echo "UPGD Output-Only + CBP experiment completed"
echo "End time: $(date)"
echo "========================================="
