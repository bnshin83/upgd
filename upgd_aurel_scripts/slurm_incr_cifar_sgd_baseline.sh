...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_sgd_baseline.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_incr_cifar_sgd_baseline.err
...
echo "Experiment: SGD Baseline (no UPGD)"
echo "Seed: 0"
echo "Start time: $(date)"
echo "========================================="

export CUDA_VISIBLE_DEVICES=0
export WANDB_RUN_NAME="${SLURM_JOB_ID}_incr_cifar_sgd_baseline_seed_0"

python3.8 incremental_cifar_experiment.py \
    --config ./cfg/sgd_baseline.json \
    --verbose \
    --experiment-index 0
