#!/bin/bash
#SBATCH --job-name=upgd_input_aware_mini_imagenet_seed_2_option_d_alpha_0.5
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_mini_imagenet_seed_2_option_d_alpha_0.5.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_mini_imagenet_seed_2_option_d_alpha_0.5.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_input_aware_mini_imagenet_seed_2_option_d_alpha_0.5"
...
echo "========================================="
echo "Running Input-Aware UPGD Mini-ImageNet Statistics - OPTION D (GATING ONLY)"
