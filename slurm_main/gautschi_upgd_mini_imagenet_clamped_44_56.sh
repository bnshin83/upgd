...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped_44_56_mini_imagenet_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped_44_56_mini_imagenet_seed_2.err
