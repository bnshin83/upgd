#!/bin/bash
#SBATCH --job-name=upgd_fo_global_mini_imagenet_seeds
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_fo_global_mini_imagenet_seeds.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_fo_global_mini_imagenet_seeds.err
...
run_seed() {
    ...
    export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_fo_global_mini_imagenet_seed_${seed}"
