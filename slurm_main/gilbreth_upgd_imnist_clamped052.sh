#!/bin/bash
#SBATCH --job-name=upgd_clamped052_imnist_seed_2
...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped052_imnist_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped052_imnist_seed_2.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_clamped052_imnist_seed_2"
export WANDB_MODE="online"

echo "========================================="
echo "Running UPGD Clamped-0.52 (Input-Permuted MNIST)"
