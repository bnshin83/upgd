#!/bin/bash
#SBATCH --job-name=snp_emnist_seed_2
...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_snp_emnist_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_snp_emnist_seed_2.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_snp_emnist_seed_2"
export WANDB_MODE="online"

echo "========================================="
echo "Running S&P (Shrink & Perturb) EMNIST Baseline"
...
# Run S&P EMNIST baseline with paper hyperparameters
...
echo "End time: $(date)"
echo "JSON results saved to: logs/label_permuted_emnist_stats/sgd/fully_connected_relu_with_hooks/lr_0.01_sigma_0.01_beta_utility_0.9_weight_decay_0.001_n_samples_1000000/2.json"
echo "WandB Run: ${WANDB_RUN_NAME}"
echo "SLURM logs: /scratch/gilbreth/shin283/upgd/logs/${SLURM_JOB_ID}.out"
echo "========================================"
