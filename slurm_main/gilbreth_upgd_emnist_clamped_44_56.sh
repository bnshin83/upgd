...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped_44_56_emnist_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped_44_56_emnist_seed_2.err
