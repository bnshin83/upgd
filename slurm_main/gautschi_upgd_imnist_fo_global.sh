...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_fo_global_imnist_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_fo_global_imnist_seed_2.err
