#!/bin/bash
#SBATCH --job-name=upgd_fo_global_emnist_seed_2
...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_fo_global_emnist_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_fo_global_emnist_seed_2.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_fo_global_emnist_seed_2"
export WANDB_MODE="online"

echo "========================================="
echo "Running UPGD (Full) on EMNIST"
...
echo "========================================="
echo "UPGD (Full) EMNIST experiment completed"
echo "End time: $(date)"
echo "========================================"
