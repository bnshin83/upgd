...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_outputonly_imnist_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_outputonly_imnist_seed_2.err
