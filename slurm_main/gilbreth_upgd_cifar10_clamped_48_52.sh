#!/bin/bash
#SBATCH --job-name=upgd_clamped_48_52_cifar10_seed_2
...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped_48_52_cifar10_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_clamped_48_52_cifar10_seed_2.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_clamped_48_52_cifar10_seed_2"
export WANDB_MODE="online"

echo "========================================="
echo "Running UPGD Symmetric Clamping [0.48, 0.52] (CIFAR-10)"
