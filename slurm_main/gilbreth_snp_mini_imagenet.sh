...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_snp_mini_imagenet_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_snp_mini_imagenet_seed_2.err
...
echo "WandB Run: ${WANDB_RUN_NAME}"
echo "SLURM logs: /scratch/gilbreth/shin283/upgd/logs/${SLURM_JOB_ID}_snp_mini_imagenet_seed_2.out"
echo "========================================"
