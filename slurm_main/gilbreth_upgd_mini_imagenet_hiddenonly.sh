...
#SBATCH --output=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_hiddenonly_mini_imagenet_seed_2.out
#SBATCH --error=/scratch/gilbreth/shin283/upgd/logs/%j_upgd_hiddenonly_mini_imagenet_seed_2.err
