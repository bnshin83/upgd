...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped052_emnist_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped052_emnist_seed_2.err
