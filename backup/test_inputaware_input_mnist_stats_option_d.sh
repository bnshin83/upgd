#!/bin/bash
#SBATCH --job-name=upgd_input_aware_input_mnist_seed_0_option_d_alpha_0.5
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_input_mnist_seed_0_option_d_alpha_0.5.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_input_mnist_seed_0_option_d_alpha_0.5.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_input_aware_input_mnist_seed_0_option_d_alpha_0.5"
...
echo "========================================="
echo "Running Input-Aware UPGD Input Permuted MNIST Statistics - OPTION D (GATING ONLY)"
echo "Start time: $(date)"
echo "Available GPUs: $(nvidia-smi -L | wc -l)"
echo "Dataset: Input Permuted MNIST (10 tasks, 784-dim permuted inputs)"
