#!/bin/bash
#SBATCH --job-name=upgd_input_aware_mini_imagenet_curv_0.005_seed_2_gating_only_a_1_b_1
...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_mini_imagenet_curv_0.005_seed_2_gating_only_a_1_b_1.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_input_aware_mini_imagenet_curv_0.005_seed_2_gating_only_a_1_b_1.err
...
export WANDB_RUN_NAME="${SLURM_JOB_ID}_upgd_input_aware_mini_imagenet_curv_0.005_seed_2_gating_only_a_1_b_1"
...
echo "========================================="
echo "Running Input-Aware UPGD Mini-ImageNet Statistics - GATING ONLY"
...
echo "Curvature threshold: 0.005 (τ)"
echo "Lambda max: 2.0"
...
echo "End time: $(date)"
echo "JSON results saved to: logs/label_permuted_mini_imagenet_stats/input_aware_upgd_fo_global/fully_connected_relu_with_hooks/lr_0.01_sigma_0.001_curvature_threshold_0.005_lambda_max_2.0_hutchinson_samples_5_n_samples_1000000_disable_regularization_True_disable_gating_False_map_${UPGD_LAMBDA_MAPPING}_gate_${UPGD_GATING_STRATEGY}_a_${UPGD_OPTION_C_A}_b_${UPGD_OPTION_C_B}_ming_${UPGD_MIN_GATING}_n5_tau_0.005/2.json"
echo "WandB Run: ${WANDB_RUN_NAME}"
