...
#SBATCH --output=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped_48_52_emnist_seed_2.out
#SBATCH --error=/scratch/gautschi/shin283/upgd/logs/%j_upgd_clamped_48_52_emnist_seed_2.err
